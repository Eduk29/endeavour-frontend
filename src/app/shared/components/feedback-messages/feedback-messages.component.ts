...
import { IFeedbackMessageParameters } from './model/feedback-message-parameters.model';
...
export class FeedbackMessagesComponent {
  constructor(@Inject(MAT_SNACK_BAR_DATA) public feedbackMessageParameters: IFeedbackMessageParameters) {}
